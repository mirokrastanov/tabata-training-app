...
function ActiveBtn({
    ...
    return (
        <button className={`group transition-all ${width} ${height} ${my} p-0 text-lg flex justify-center items-center bg-purple-900 text-white rounded-lg hover:bg-purple-600 active:bg-purple-500 focus:outline-none border-none transition-all`} onClick={handler} type={btnType} data-preset={preset}>
