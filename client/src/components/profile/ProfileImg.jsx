...
function ProfileImg({ dUser }) {
    const imgClasses = 'h-[70px] w-[70px] rounded-full max-custom-mq-500:w-[90px] max-custom-mq-500:h-[90px] max-custom-mq-300:w-[70px] max-custom-mq-300:h-[70px] max-custom-mq-300:p-0 ';
