...
function Home() {
    // Conditional title bar --> MOVE to APP.jsx and define conditional rendering criteria
    // Same for the overlay at the bottom

    // Dynamic content --> remains here as the sole HOME.jsx element
    ...
    return (
        ...
        <div id="app__wrapper" className="bg-purple-900 text-white min-w-full max-w-[23rem] max-h-[46rem] flex flex-nowrap flex-col justify-start items-stretch rounded-xl relative">
            ...
            {/* Remains here as the only element */}
